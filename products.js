const PRODUCTS = [

  {
    ...
    price: 319,
    category: "hijab",
    description: "Animal Print Hijab — thoughtfully selected for the Layora collection.",
    image: "assets/products/LAY001-1.jpg",
    images: [
      "assets/products/LAY001-1.jpg",
      "assets/products/LAY001-2.jpg",
      "assets/products/LAY001-3.jpg",
      "assets/products/LAY001-4.jpg",
      "assets/products/LAY001-5.jpg",
      "assets/products/LAY001-6.jpg",
      "assets/products/LAY001-7.jpg",
      "assets/products/LAY001-8.jpg",
      "assets/products/LAY001-9.jpg"
    ],
    colours: ["Black", "Beige", "Pink", "Maroon", "Other"],
    featured: true
  },

  {
    ...
    description: "Bandana — thoughtfully selected for the Layora collection.",
    image: "assets/products/LAY002.jpg",
    colours: ["Black", "Beige", "Pink", "Maroon", "Other"],
    featured: false
  },

  {
    ...
    price: 340,
    category: "hijab",
    description: "Bridal Georgette — thoughtfully selected for the Layora collection.",
    image: "assets/products/LAY003.jpg",
    colours: ["Black", "Beige", "Pink", "Maroon", "Other"],
    featured: true
  },

  {
    ...
    price: 319,
    category: "hijab",
    description: "Bubble Satin Stone — thoughtfully selected for the Layora collection.",
    image: "assets/products/LAY004.jpg",
    colours: ["Black", "Beige", "Pink", "Maroon", "Other"],
    featured: true
  },

  {
    ...
    price: 200,
    category: "hijab",
    description: "Cotton Hijab — thoughtfully selected for the Layora collection.",
    image: "assets/products/LAY005.jpg",
    colours: ["Black", "Beige", "Pink", "Maroon", "Other"],
    featured: false
  },
  ...
  {
    id: "LAY006",
    name: "Cotton Black & White Hijab",
    price: 140,
    category: "hijab",
    description: "Cotton Black & White Hijab — thoughtfully selected for the Layora collection.",
    image: "assets/products/LAY006.jpg",
    colours: ["Black", "Beige", "Pink", "Maroon", "Other"],
    featured: false
  },
  ...
  {
    id: "LAY007",
    name: "Cotton Print Hijab",
    price: 259,
    category: "hijab",
    description: "Cotton Print Hijab — thoughtfully selected for the Layora collection.",
    image: "assets/products/LAY007.jpg",
    colours: ["Black", "Beige", "Pink", "Maroon", "Other"],
    featured: false
  },
  ...
  {
    id: "LAY008",
    name: "Digital Print Hijab",
    price: 299,
    category: "hijab",
    description: "Digital Print Hijab — thoughtfully selected for the Layora collection.",
    image: "assets/products/LAY008.jpg",
    colours: ["Black", "Beige", "Pink", "Maroon", "Other"],
    featured: true
  },
  ...
  {
    id: "LAY009",
    name: "Edgem Embroidery",
    price: 349,
    category: "hijab",
    description: "Edgem Embroidery — thoughtfully selected for the Layora collection.",
    image: "assets/products/LAY009.jpg",
    colours: ["Black", "Beige", "Pink", "Maroon", "Other"],
    featured: false
  },
  ...
  {
    id: "LAY010",
    name: "Embroidery Organza",
    price: 329,
    category: "hijab",
    description: "Embroidery Organza — thoughtfully selected for the Layora collection.",
    image: "assets/products/LAY010.jpg",
    colours: ["Black", "Beige", "Pink", "Maroon", "Other"],
    featured: true
  },
  ...
  {
    id: "LAY011",
    name: "Floral Print Cotton Hijab",
    price: 140,
    category: "hijab",
    description: "Floral Print Cotton Hijab — thoughtfully selected for the Layora collection.",
    image: "assets/products/LAY011.jpg",
    colours: ["Black", "Beige", "Pink", "Maroon", "Other"],
    featured: false
  },
  ...
  {
    id: "LAY012",
    name: "Hesh Nine Black Hijab",
    price: 299,
    category: "hijab",
    description: "Hesh Nine Black Hijab — thoughtfully selected for the Layora collection.",
    image: "assets/products/LAY012.jpg",
    colours: ["Black", "Beige", "Pink", "Maroon", "Other"],
    featured: false
  },
...

  {
    ...
    colours: ["Black", "Beige", const PRODUCTS = [
